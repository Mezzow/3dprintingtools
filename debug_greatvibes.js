// Debug: verify the connection-skip logic with DejaVu Sans
...
async function main() {
  ...
  // Wide scan for connection check
  ...
  fs.writeFileSync("debug_preview.png", cv.toBuffer("image/png"));
  console.log("Saved debug_preview.png");
}
